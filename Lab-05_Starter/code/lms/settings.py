...
SILKY_PYTHON_PROFILER = True  # Aktifkan profiler
SILKY_AUTHENTICATION = False   # Nonaktifkan auth untuk development (opsional)
SILKY_AUTHORISATION = False    # Nonaktifkan auth untuk development (opsional)
SILKY_INTERCEPT_PERCENT = 100  # Rekam 100% request (default sudah 100)